...
Your assignment is to build a small front-end application that uses the PyPi API to display information about the following packages.
...
* When displaying a package it should list the following information...
  * The package name
  * A list available versions 
    * Found in `releases` in the response
  * A list of clickable project URLs
